...
for (i=0; i<gugunlen; i++) {
  selform.staaddr2.options[i] = new Option(regionArray[sidoindex][i], regionArray[sidoindex][i]);
...
<FORM name='frm' method='POST' action='./create.do' enctype="multipart/form-data" id='insertBoardFrm'>
	<table width='100%'>
		<tr>
			<th colspan='4'>구장 등록</th>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
		<tr>
			<th colspan='4'>※모든 정보가 필수 입력 사항 입니다.</th>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
		<tr>
			<th>●구장 이름</th>
			<td><input type='text' name='staname' autofocus required></td>
			<th>●구장주 아이디</th>
			<td><input type='text' name='id' value='${s_id }' autofocus required></td>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
		<tr>
			<th>●구장 주소</th>
			<td>
				<select name="staaddr1" OnChange="changeRegion(frm)"></select>
				<select name="staaddr2"></select>* 지역을 선택하세요.<br>
				<input type='text' name='staaddr3'>상세 주소를 입력하시오
			</td>	
			<th>●대여 가격</th>
			<td><input type='text' name='stapay' autofocus required>원</td>
		...
		<tr>
			...
			<td colspan='4'><jsp:include page="./smartedit.jsp"></jsp:include></td>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
		<tr>
			<th>●개장 시간</th>
			<td><input type='text' name='staopen' autofocus required>:00</td>
			<th>●마감 시간</th>
			<td><input type='text' name='staclose' autofocus required>:00</td>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
		<tr>
			<th>●구장 등록 비밀번호</th>
			<td><input type="password" name='stapasswd' value='${s_pw }' autofocus required readonly></td>
			
		   
			<th>●구장 사진</th>
			<td>		
			
					<input type="file"  name='posterMF1'></option>
					<input type="file"  name='posterMF2'></option>	
					<input type="file"  name='posterMF3'></option>	
					<input type="file"  name='posterMF4'></option>	
					<input type="file"  name='posterMF5'></option>		
		...
		<tr>
			<td colspan='3'></td>
			<td><input type='submit' value='경기장 등록' onclick="return cityCheck(this.form)"> <a
				href='stadiumlist.do'><input type='button' value='취소'></a></td>
		</tr>
		<tr>
			<th colspan='4'><hr></th>
		</tr>
