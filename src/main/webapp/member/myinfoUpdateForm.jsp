...
//아래는 윤달을 구하는 것
 ...
 document.writeln("</select>일"); 
     ...
     <table style="margin:auto;">
      ...
      <tr>
	   <th>비밀번호</th>
	   <td><input type="password" name="pw" id="pw" size="15" value="${dto.pw }" required="required"></td>
      </tr>
      <tr>
	   <th>비밀번호 확인</th>
      ...
      <tr>
	   <th>전화번호</th>
	   <td><input type="text" name="tel" id="tel" size="15" value="${dto.tel }"></td>
      </tr>
      <tr>
	   <th>이메일</th>
	   <td><input type="text" name="mail" id="mail" size="30" value="${dto.mail }"></td>
      </tr>
      ...
      <tr>  
       <th>주소</th>
       <td><input type="text" name="address1" id="address1" size="45" value="${dto.address1 }"readonly></td>
      </tr>
      <tr>  
       <th>나머지주소</th>
       <td><input type="text" name="address2" id="address2" size="45" value="${dto.address2 }"></td>
     </tr>
     <tr>
	  <td colspan="2">
	   <input type="submit" value="회원정보 수정"/>
	   <input type="button"  value="취소" onclick="location.href='./myinfo.do'"/>
	  </td>
     </tr>
    </table>
